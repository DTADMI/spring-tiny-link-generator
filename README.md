...
* A firestore (NoSQL database) account configured to be accessible via the application (the implementation of the DB can be switched to any other one, but we went with Firestore here)
